...
from Mol_Toxpred.MoleculeNet_Graph import MoleculeNetGraphDataset, CustomDataset
...
from Mol_Toxpred.molecule_graph_model import Graph_pred
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_model_dir", type=str, default='save_model/task4_tox/Ames')
