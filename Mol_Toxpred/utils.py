...
def get_molecule_repr_MoleculeSTM(molecule_data, mol2latent=None, molecule_type="Graph", MegaMolBART_wrapper=None, molecule_model=None):
...
def get_num_task_and_type(dataset):
    if dataset in ["LD50", "esol", "freesolv", "lipophilicity"]:
        return 1, "regression"
    elif dataset in ["hiv", "bace", "bbbp"]:
        return 1, "classification"
    elif dataset in ["Ames", "DILI", "hERG", "Skin Reaction"]:
        return 1, "classification"
    elif dataset == "tox21":
